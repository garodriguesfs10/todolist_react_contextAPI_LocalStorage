...
const TodoListApp = () => {
    ...
    return (
        <div className="container mt-4">
            <h3>Bem vindo <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bug" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <h4>Você está nesse site há: {hora}s</h4>
            <TodoProvider>
                <TodoList />
                <br />
                <hr></hr>
